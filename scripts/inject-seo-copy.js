...
const EN_SECTION = {
  ...
  p3: 'Search “<strong>best audiobook apps</strong>” and you’ll find storefronts, subscriptions, and cloud libraries. Apple audiobooks, including Apple Books audiobooks, Audible audiobooks, and YouTube audiobooks can help you discover a title; each has its own catalogue, terms, and availability. Search phrasing varies too: someone looking for “audiobooks Apple” is usually comparing the same Apple Books catalogue. HushBook solves a different problem: <em>how you read the audio you already have</em>. Import your own MP3, M4B, FLAC, and more; chapters and cover art come along when the file includes them. Tap Transcribe, and the on-device HushBook Engine builds synchronized text — no lyrics database, no upload, no account. After a one-time engine download, the whole experience works offline. That private, file-first design is rare among mainstream <strong>audiobook apps for iPhone</strong> and <strong>audiobook apps for Android</strong>.',
  h3c: 'Where to find free audiobooks on iPhone and Android',
  p4: 'Wondering <strong>where to find free audiobooks</strong>? Start with the public-domain library in HushBook, featuring classics from LibriVox and the Internet Archive that you can browse and download. It is a free audiobooks app for iPhone and Android, with no ads in the core experience: listen to audiobooks for free, read along, save quotes, and play offline. For free audiobooks online, check the source and rights before downloading. If you are comparing an audiobooks subscription or an audiobooks free trial, use it to discover paid catalogues; HushBook remains free for the books you already own and the public-domain titles you choose. Whether you need audiobooks iPhone users can follow word by word on a commute or an Android player for bedtime listening, the promise stays the same: private by design, synced text included.',
  h3d: 'Your books — from classics to a Project Hail Mary audiobook',
  p5: 'Lists of the <strong>best audiobooks 2026</strong>, best audiobooks 2025, and top audiobooks are a useful starting point, but the right pick is personal. Bring the titles you care about: thriller audiobooks for a late-night walk, fantasy audiobooks for a long trip, romance audiobooks for a quiet evening, or audiobooks for kids for a family car ride. If you buy audiobooks elsewhere, import a <strong>Project Hail Mary audiobook</strong> file you already own (or any other book you have rights to play), run transcription on your phone, and follow Ryland Grace word by word. Prefer public-domain epics? Start with Monte Cristo, Austen, or Aurelius from the built-in catalogue. HushBook is not a piracy storefront — it is a player and read-along engine for files and free classics you choose. Synced text works across languages too: the engine supports dozens of tongues so an <strong>audiobook with words</strong> can match the language you hear.',
...
// Local equivalents of English discovery keywords. These are intent-led copy,
// not literal keyword translations: each locale gets its own natural search
// vocabulary while preserving HushBook's rights and catalogue boundaries.
const LOCALIZED_DISCOVERY = {
  de: 'Bei der Suche nach den besten Hörbüchern 2026 oder den Favoriten aus 2025 helfen Listen nach Genre — etwa Thriller, Fantasy, Romance oder Hörbücher für Kinder. Apple Books, Audible und YouTube können bei der Entdeckung helfen; für kostenlose Hörbücher lohnen sich gemeinfreie Quellen wie LibriVox und Internet Archive. Ein Abo oder kostenloser Probemonat kann einen Katalog erschließen, HushBook bleibt jedoch der private Player für eigene Dateien und freie Klassiker.',
  fr: 'Les listes des meilleurs livres audio 2026 ou des favoris 2025 sont un bon point de départ, qu’il s’agisse de thrillers, de fantasy, de romances ou de livres audio pour enfants. Apple Books, Audible et YouTube peuvent aider à découvrir un titre ; pour des livres audio gratuits, privilégiez les sources du domaine public comme LibriVox et Internet Archive. Un abonnement ou un essai gratuit donne accès à certains catalogues, tandis que HushBook lit vos fichiers et les classiques libres de droits.',
  es: 'Las listas de los mejores audiolibros de 2026 o los favoritos de 2025 son un buen punto de partida, ya busques thriller, fantasía, romance o audiolibros para niños. Apple Books, Audible y YouTube pueden ayudarte a descubrir un título; para audiolibros gratis, busca fuentes de dominio público como LibriVox e Internet Archive. Una suscripción o prueba gratuita abre algunos catálogos, mientras HushBook reproduce tus archivos y clásicos de uso libre.',
  pt: 'Listas dos melhores audiolivros de 2026 ou favoritos de 2025 ajudam a escolher thriller, fantasia, romance ou audiolivros infantis. Apple Books, Audible e YouTube podem ajudar a descobrir um título; para audiolivros grátis, prefira fontes de domínio público como LibriVox e Internet Archive. Uma assinatura ou teste grátis abre alguns catálogos, enquanto o HushBook reproduz seus arquivos e clássicos livres.',
  it: 'Le liste dei migliori audiolibri del 2026 o dei preferiti del 2025 sono un buon punto di partenza, tra thriller, fantasy, romance e audiolibri per bambini. Apple Books, Audible e YouTube possono aiutare a scoprire un titolo; per gli audiolibri gratuiti, scegli fonti di pubblico dominio come LibriVox e Internet Archive. Un abbonamento o una prova gratuita apre alcuni cataloghi, mentre HushBook riproduce i tuoi file e i classici liberi.',
  nl: 'Lijstjes met de beste luisterboeken van 2026 of favorieten uit 2025 helpen bij het kiezen van thrillers, fantasy, romance of luisterboeken voor kinderen. Apple Books, Audible en YouTube kunnen helpen een titel te vinden; voor gratis luisterboeken kies je betrouwbare public-domainbronnen zoals LibriVox en Internet Archive. Een abonnement of gratis proefperiode geeft toegang tot sommige catalogi, terwijl HushBook je eigen bestanden en vrije klassiekers afspeelt.',
  pl: 'Listy najlepszych audiobooków 2026 i ulubionych tytułów z 2025 pomagają wybrać thriller, fantasy, romans lub audiobooki dla dzieci. Apple Books, Audible i YouTube mogą pomóc odkryć tytuł; darmowych audiobooków szukaj w zaufanych źródłach domeny publicznej, takich jak LibriVox i Internet Archive. Subskrypcja lub bezpłatny okres próbny otwiera część katalogów, a HushBook odtwarza Twoje pliki i wolne klasyki.',
  sv: 'Listor över bästa ljudböcker 2026 eller favoriter från 2025 hjälper dig att välja thrillers, fantasy, romance eller ljudböcker för barn. Apple Books, Audible och YouTube kan hjälpa dig att hitta en titel; för gratis ljudböcker är public-domain-källor som LibriVox och Internet Archive ett bra val. Abonnemang och kostnadsfria provperioder öppnar vissa kataloger, medan HushBook spelar dina egna filer och fria klassiker.',
  da: 'Lister over bedste lydbøger 2026 eller favoritter fra 2025 hjælper med at vælge thrillere, fantasy, romance eller lydbøger til børn. Apple Books, Audible og YouTube kan hjælpe med at finde en titel; til gratis lydbøger er public-domain-kilder som LibriVox og Internet Archive et godt valg. Abonnementer og gratis prøveperioder åbner nogle kataloger, mens HushBook afspiller dine egne filer og frie klassikere.',
  ja: '2026年のおすすめオーディオブックや2025年の人気作リストは、ミステリー、ファンタジー、ロマンス、子ども向け作品を選ぶ出発点になります。Apple Books、Audible、YouTubeは作品探しに役立ちますが、無料作品はLibriVoxやInternet Archiveなど信頼できるパブリックドメインの提供元を選びましょう。サブスクリプションや無料体験で使えるカタログもあり、HushBookは所有する音声ファイルと無料の古典を再生します。',
  ko: '2026년 최고의 오디오북이나 2025년 인기작 목록은 스릴러, 판타지, 로맨스, 어린이 오디오북을 고르는 좋은 출발점입니다. Apple Books, Audible, YouTube는 작품을 찾는 데 도움이 되며, 무료 오디오북은 LibriVox와 Internet Archive 같은 신뢰할 수 있는 퍼블릭 도메인 출처를 이용하세요. 구독이나 무료 체험으로 일부 카탈로그를 이용할 수 있고, HushBook은 소유한 파일과 무료 고전을 재생합니다.',
  ru: 'Подборки лучших аудиокниг 2026 года и фаворитов 2025 года помогают выбрать триллер, фэнтези, роман или аудиокнигу для детей. Apple Books, Audible и YouTube подходят для поиска названия; бесплатные аудиокниги ищите в надёжных источниках общественного достояния, таких как LibriVox и Internet Archive. Подписка или бесплатный пробный период открывают некоторые каталоги, а HushBook воспроизводит ваши файлы и свободную классику.',
  uk: 'Добірки найкращих аудіокниг 2026 року й фаворитів 2025 року допомагають обрати трилер, фентезі, роман чи аудіокнигу для дітей. Apple Books, Audible і YouTube допоможуть знайти назву; безкоштовні аудіокниги шукайте в надійних джерелах суспільного надбання, як-от LibriVox та Internet Archive. Передплата або безкоштовний пробний період відкривають деякі каталоги, а HushBook відтворює ваші файли й вільну класику.',
  tr: '2026’nın en iyi sesli kitapları ve 2025’in favorileri listeleri; gerilim, fantastik, romantik veya çocuk sesli kitapları seçmek için iyi bir başlangıçtır. Apple Books, Audible ve YouTube bir kitap keşfetmenize yardımcı olabilir; ücretsiz sesli kitaplar için LibriVox ve Internet Archive gibi güvenilir kamu malı kaynakları tercih edin. Abonelik veya ücretsiz deneme bazı katalogları açar; HushBook ise kendi dosyalarınızı ve ücretsiz klasikleri oynatır.',
  id: 'Daftar audiobook terbaik 2026 atau favorit 2025 membantu memilih thriller, fantasi, roman, atau audiobook anak. Apple Books, Audible, dan YouTube dapat membantu menemukan judul; untuk audiobook gratis, pilih sumber domain publik tepercaya seperti LibriVox dan Internet Archive. Langganan atau uji coba gratis membuka beberapa katalog, sedangkan HushBook memutar file milik Anda dan karya klasik bebas.',
  th: 'รายชื่อหนังสือเสียงที่ดีที่สุดปี 2026 หรือเรื่องโปรดปี 2025 ช่วยเลือกแนวระทึกขวัญ แฟนตาซี โรแมนซ์ หรือหนังสือเสียงสำหรับเด็กได้ Apple Books, Audible และ YouTube ช่วยค้นหาชื่อเรื่องได้ ส่วนหนังสือเสียงฟรีควรเลือกแหล่งสาธารณสมบัติที่เชื่อถือได้ เช่น LibriVox และ Internet Archive การสมัครสมาชิกหรือทดลองใช้ฟรีเปิดแคตตาล็อกบางส่วน ขณะที่ HushBook เล่นไฟล์ที่คุณมีและงานคลาสสิกฟรี',
  vi: 'Danh sách sách nói hay nhất năm 2026 hoặc các tác phẩm được yêu thích năm 2025 là điểm khởi đầu tốt để chọn trinh thám, giả tưởng, lãng mạn hay sách nói cho trẻ em. Apple Books, Audible và YouTube có thể giúp tìm tựa sách; với sách nói miễn phí, hãy chọn nguồn phạm vi công cộng đáng tin cậy như LibriVox và Internet Archive. Gói đăng ký hoặc dùng thử miễn phí mở một số danh mục, còn HushBook phát tệp bạn sở hữu và các tác phẩm kinh điển miễn phí.',
  ar: 'تساعد قوائم أفضل الكتب الصوتية لعام 2026 والمفضلة في 2025 على اختيار التشويق أو الفانتازيا أو الرومانسية أو الكتب الصوتية للأطفال. قد تساعد Apple Books وAudible وYouTube في اكتشاف عنوان؛ وللكتب الصوتية المجانية، اختر مصادر موثوقة ضمن الملكية العامة مثل LibriVox وInternet Archive. تفتح الاشتراكات أو التجارب المجانية بعض الكتالوجات، بينما يشغّل HushBook ملفاتك والكتب الكلاسيكية المجانية.',
};
...
function regionalizeConfig(cfg, locale) {
  ...
  return {
    ...
    section: {
      ...regionalizeSection(cfg.section, locale),
      discovery: LOCALIZED_DISCOVERY[locale] || LOCALIZED_DISCOVERY[locale.split('-')[0]],
    },
  };
}
